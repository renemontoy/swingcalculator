  ...
  return (
    <div style={styles.containerWrapper}>
      <div style={styles.container}>
        <h1 style={styles.title}>Swingweight Calculator</h1>
...
const styles = {
    ...
    container: { 
      ...
      margin: "0 auto",
      fontSize: "clamp(14px, 1.5vw, 30px)", // Escala entre 14px y 18px según el ancho
    },
    title: {     
      fontSize: "clamp(24px, 1.5vw, 600px)", // Escala de 24px a 32px
      fontWeight: "bold", 
    },
    subtitle: { 
