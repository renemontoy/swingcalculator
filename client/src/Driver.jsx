...
export default function DriverSwing() {
  const shaftList = {
    "Fujikura Grand Bassara 29 L": "D0",
    ...
    "Graphite Design Tour AD HD 4- R2": "D2",
    "Graphite Design Tour AD HD 5- R": "D3",
    "Graphite Design Tour AD HD 5- S": "D4",
    "Graphite Design Tour AD IZ 5- R": "D3",
    "Graphite Design Tour AD IZ 5- R2": "D3",
    "Graphite Design Tour AD VF 5 - S": "D3",
    "Graphite Design Tour AD VF 5 - X": "D3",
    "Graphite Design Tour AD VF 6 - S": "D4",
    "Graphite Design Tour AD VF 6 - X": "D4",
    "Graphite Design Tour AD VF 7 - S": "D5",
    "Graphite Design Tour AD VF 7 - X": "D5",
    "Graphite Design Tour AD XC 4 - R2": "D1",
    "Graphite Design Tour AD XC 5 - R": "D3",
    "Graphite Design Tour AD XC 5 - S": "D4",
    "Graphite Design Tour AD XC 6- S": "D4",
    "Graphite Design Tour AD XC 6- X": "D5",
    "Graphite Design Tour AD XC 7-X": "D6",
    "KBS PGW 50 - R": "D4",
    "KBS PGW 60 - R": "D5",
    "KBS PGW 60 - S": "D6",
    "KBS PGW 60 - X": "D6",
    ...
    "MCA Kai'li Blue 60 R": "D5",
    "MCA Kai'li Blue 60 S": "D5",
    "MCA Kai'li Blue 60 X": "D5",
    "MCA Kai'li Blue 70 S": "D5",
    "MCA Kai'li Blue 70 X": "D5",
  ...
  const [toe, setToe] = useState(findInitialZeroValue(toeOptions, "Black Ops Driver"));
  const [heel, setHeel] = useState(findInitialZeroValue(HeelOptions, "Black Ops Driver"));
  const [back, setBack] = useState(findInitialZeroValue(BackOptions, "Black Ops Driver"));
